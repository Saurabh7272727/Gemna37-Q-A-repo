                        ...
                        <div className="flex flex-col h-full bg-gray-900 relative">
                            ...
                            <div className="border-b z-50 bg-gray-900 md:w-[59%] w-auto border-gray-700 px-4 py-3 sm:px-6 sm:py-4 fixed top-[8%]">
                                <div className="flex items-center justify-between">
                                    ...
                                    {
                                        state?.data.socketId ? <div className="inline-flex items-center px-3/2 py-1 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 shadow-sm">
                                        ...
                                        </div> : <div className="inline-flex items-center md:px-3 px-3/2 py-1/2 rounded-full bg-gradient-to-r from-red-500 to-red-600 shadow-sm">
                                            <div className="w-1.5 h-1.5 bg-white rounded-full mr-2 animate-pulse"></div>
