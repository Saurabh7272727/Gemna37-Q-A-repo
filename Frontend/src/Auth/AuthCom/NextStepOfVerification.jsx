...
const OtpCard = lazy(() => import("./OtpCard.jsx"));
import CircularProgress from '@mui/material/CircularProgress';
import { ToastContainer } from 'react-toastify';
import Message from '../../MessageGemnaCenter/toast.js';
import { encryptData } from '../Encryption/jsondataEncryption.js';
import {
    FaCheckCircle,
    FaUser,
    FaUsers,
...
const StudentDetailsDisplay = ({ responseData }) => {
    const [otpShowCard, setOtpShowCard] = useState(false);
    ...
    const EmailHandler = async () => {
        ...
        try {
            ...
            console.log(error);
            setLoading(false);
            alert("something was wrong in frontend");
    ...
    return (
        <>
            {
                otpShowCard ? <div className='w-screen h-screen flex justify-center items-center pb-10'> <Suspense fallback={<CircularProgress />}>
                    <OtpCard />
                </Suspense> </div> :
                            ...
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-100">
                                        ...
                                        <div className="text-[18px] md:text-xl font-bold text-blue-900 bg-white py-3 px-4 rounded-lg shadow-inner">
                                            {data.GEMID}
                                        </div>
