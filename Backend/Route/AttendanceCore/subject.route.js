...
import { fetchRelatedSubjectByStudent, linkTheRelatedSubject, getAllLinkedSuject, scheduleTheTime } from '../../Controller/AttendanceController/subject.controller.js';
...
router.post('/post/timetable/:AttendanceId', UserAccessMiddleware, scheduleTheTime)
